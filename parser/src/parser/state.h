...
enum class STATE {
    ...
    IDENTIFIER_NAME,
    IDENTIFIER_COMPLETE,
    IDENTIFIER_COMPLETE_WHITESPACE,
    EXPECT_TYPE_ANNOTATION,
    TYPE_ANNOTATION,
    TYPE_ANNOTATION_WHITESPACE,
    TYPE_UNION_SEPARATOR_WHITESPACE,
    TYPE_INTERSECTION_SEPARATOR_WHITESPACE,
    EXPECT_EQUALS,
...
inline const char* stateToString(STATE state) {
    switch (state) {
        ...
        case STATE::IDENTIFIER_COMPLETE_WHITESPACE: return "IDENTIFIER_COMPLETE_WHITESPACE";
        case STATE::EXPECT_TYPE_ANNOTATION: return "AWAIT_TYPE_ANNOTATION";
        case STATE::TYPE_ANNOTATION: return "TYPE_ANNOTATION";
        case STATE::TYPE_ANNOTATION_WHITESPACE: return "TYPE_ANNOTATION_WHITESPACE";
        case STATE::TYPE_UNION_SEPARATOR_WHITESPACE: return "TYPE_UNION_SEPARATOR_WHITESPACE";
        case STATE::TYPE_INTERSECTION_SEPARATOR_WHITESPACE: return "TYPE_INTERSECTION_SEPARATOR_WHITESPACE";
