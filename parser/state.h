...
enum class STATE {
    ...
    INTERFACE_PROPERTY_COLON,
    INTERFACE_PROPERTY_TYPE,
    INTERFACE_PROPERTY_SEPARATOR,
...
inline const char* stateToString(STATE state) {
    switch (state) {
        ...
        case STATE::INTERFACE_PROPERTY_COLON: return "INTERFACE_PROPERTY_COLON";
        case STATE::INTERFACE_PROPERTY_TYPE: return "INTERFACE_PROPERTY_TYPE";
        case STATE::INTERFACE_PROPERTY_SEPARATOR: return "INTERFACE_PROPERTY_SEPARATOR";
        case STATE::INTERFACE_METHOD_KEY: return "INTERFACE_METHOD_KEY";
        ...
        case STATE::INTERFACE_METHOD_SEPARATOR: return "INTERFACE_METHOD_SEPARATOR";
        ...
        case STATE::CLASS_PROPERTY_SEPARATOR: return "CLASS_PROPERTY_SEPARATOR";
        case STATE::CLASS_METHOD_KEY: return "CLASS_METHOD_KEY";
